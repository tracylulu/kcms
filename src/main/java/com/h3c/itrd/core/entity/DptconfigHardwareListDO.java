...
@TableName("dptconfig_hardware_list")
public class DptconfigHardwareListDO implements Serializable {
    ...
    private BigDecimal reviewHard;

    private BigDecimal reviewNormal;

    private BigDecimal reviewTip;
