...
public  class AbstractExcelReader implements ExcelReader{
    ...
    public AbstractExcelReader(InputStream inputStream,String fileName) throws Exception {
    ...
    public AbstractExcelReader(InputStream inputStream,String fileName,String sheetName) throws Exception {
        initWorkBook(inputStream,fileName);
     ...
     */
    @Override
    public  void checkExcelValid(File file) throws Exception {
     ...
     */
    @Override
    public  void initWorkBook(InputStream inputStream, String fileName) throws Exception,IOException {
        if (!fileName.endsWith(EXCEL_XLS) && !fileName.endsWith(EXCEL_XLSX) && !fileName.endsWith(EXCEL_XLSM)) {
            throw new Exception("不是标准的Excel文件");
        }
        ...
        } else if (fileName.endsWith(EXCEL_XLSM)) {//启用宏的工作簿
            workbook = new XSSFWorkbook(inputStream);
        }
    }
